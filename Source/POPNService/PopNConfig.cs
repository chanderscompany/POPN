...
namespace PopNService {
    ...
    public class PopNConfig {
        ...
        public void Read() {
            object obj = DacSerializer.DeserializeAppObject(_fileName, typeof(PopNConfig), baseName: "PopN");
        ...
        public bool Write() {
            bool OK = DacSerializer.SerializeAppObject(_fileName, this, typeof(PopNConfig), baseName: "PopN");
            return OK;
        }
    }
}
